    ...
    public class StaffsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Staff != null ? 
                          ...
                          Problem("Entity set 'DBContext.Staff'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Phone")] Staff staff)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name,Email,Phone")] Staff staff)
        {
            if (id != staff.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            {
                return Problem("Entity set 'DBContext.Staff'  is null.");
            }
            var staff = await _context.Staff.FindAsync(id);
            if (staff != null)
            {
